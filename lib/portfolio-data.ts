...
export const logEntries: LogEntry[] = [
  ...
  },
  {
    ...
    icon: GitBranch,
    stamp: '2026.06',
    title: 'Software Architect / Full-Stack Lead',
    subtitle: 'UK Software Pvt. Ltd. (TheDayHR) · Jun 2026 — Present',
    body: 'Architected a secure, multi-tenant HRMS using Java and Spring Boot. Engineered full CI/CD deployment pipelines via GitHub Actions. Designed state-driven React.js frontend architecture and resilient RESTful APIs. Implemented strict JWT auth, DLT-compliant notifications, and pioneered scalable backend infrastructure.',
    tags: ['Java', 'Spring Boot', 'React', 'CI/CD', 'GitHub Actions'],
  },
  {
    id: 'uniquehire',
    section: 'experience',
    ...
    subtitle: 'Unique Hire · Mar 2026 — Present',
    body: 'Engineered HireGuard, an end-to-end AI interview platform using Next.js, FastAPI, and Supabase. Integrated LiveKit for real-time video and built a dual-path transcription pipeline (Whisper Large v3 Turbo, Pyannote 3.1, Groq). Designed strict JSON-enforced prompting pipelines with LLaMA models for candidate evaluation.',
    tags: ['Next.js', 'FastAPI', 'Supabase', 'LiveKit', 'Whisper', 'LLaMA'],
  },
  {
    id: 'organic',
    section: 'experience',
  ...
  },
  {
    ...
    icon: Award,
    stamp: 'AWD.02',
    title: 'Commendation Prize 1 — WENAMITAA',
    subtitle: 'EXPRO 2025-26, Dept. of AI & DS, NMAM Institute of Technology',
    body: 'Awarded for "AI-Driven Water Crisis Early Warning and Monitoring System for Bengaluru"; recognized among the top projects in the cohort.',
  },
  {
    id: 'cert-pres',
    section: 'research',
    ...
    subtitle: 'IEEE ICIRCA 2026, IEEE Systems, Man, and Cybernetics Society',
    body: 'Presented research on probabilistic urban water crisis prediction at the 7th International Conference on Inventive Research in Computing Applications, Coimbatore.',
  },
  {
    id: 'edu',
    section: 'research',
